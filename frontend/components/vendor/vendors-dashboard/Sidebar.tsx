...
const sidebarItems = [
	...
	{ label: "My Store", href: "/dashboard/vendor/products", icon: <FiBox /> },
...
return (
	<aside
		className={`relative h-screen bg-[#181818] border-r border-[#232323] flex flex-col transition-all duration-300 ${collapsed ? "w-20 p-2" : "w-64 p-6"}`}
	...
	>
		<div className="flex items-center justify-between mb-8">
			...
			<button
				...
				className="ml-2 p-2 rounded hover:bg-[#232323] text-[#b39ddb] focus:outline-none transition"
			...
			{sidebarItems.map((item) => (
				<Link
					...
					className={`flex items-center gap-3 px-4 py-2 rounded-lg font-medium transition-colors duration-150 group ${active === item.href
						? "bg-[#232323] text-[#b39ddb]"
						: "text-gray-300 hover:bg-[#232323] hover:text-[#b39ddb]"}
