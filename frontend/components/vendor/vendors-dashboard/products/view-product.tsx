        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-between p-8 bg-white h-full min-w-[320px]">
            ...
            <div className="flex items-center gap-4 mb-6">
              <button
                className="py-3 px-8 rounded bg-black text-white text-base font-bold shadow hover:bg-gray-800 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-black flex items-center gap-2"
                type="button"
                onClick={async () => {
                  ...
                  try {
                    const res = await fetch(`${API_URL}/api/cart/add`, {
                      ...
                      body: JSON.stringify({ user_id: USER_ID, product_id: product.id, quantity: 1 }),
                    });
